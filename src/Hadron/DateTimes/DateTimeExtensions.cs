...
public static partial class DateTimeExtensions {
    ...
    public static DateOnly GetDateOnly(this DateTime dateTime) => new(dateTime.Year, dateTime.Month, dateTime.Day);

    /// <summary>
    /// Returns the time component of the specified <see cref="DateTime"/> as a <see cref="TimeOnly"/> object.
    /// </summary>
    /// <param name="dateTime">The <see cref="DateTime"/> object.</param>
    /// <returns>A <see cref="TimeOnly"/> object representing the time component of the <paramref name="dateTime"/>.</returns>
    public static TimeOnly GetTimeOnly(this DateTime dateTime) => new(dateTime.Hour, dateTime.Minute, dateTime.Second, dateTime.Millisecond);

    /// <summary>
    /// Returns the date and time components of the specified <see cref="DateTime"/> as a tuple of <see cref="DateOnly"/> and <see cref="TimeOnly"/> objects.
    /// </summary>
    /// <param name="dateTime">The <see cref="DateTime"/> object.</param>
    /// <returns>A tuple of <see cref="DateOnly"/> and <see cref="TimeOnly"/> objects representing the date and time components of the <paramref name="dateTime"/>.</returns>
    public static (DateOnly Date, TimeOnly Time) DateAndTimeOnly(this DateTime dateTime) => (dateTime.GetDateOnly(), dateTime.GetTimeOnly());
}