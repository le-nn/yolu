...
public static class TimeSpanExtensions {
    /// <summary>
    /// Adds the given <see cref="TimeSpan"/> from a <see cref="TimeSpan"/> and returns resulting <see cref="TimeSpan"/>.
    /// </summary>
    [Pure]
    public static TimeSpan AddTimeSpan(this TimeSpan timeSpan, TimeSpan TimeSpan) =>
